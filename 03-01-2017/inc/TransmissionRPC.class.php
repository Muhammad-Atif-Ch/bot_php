...
class TransmissionRPC
{
  ...
  protected function cleanRequestData ( $array )
  {
    ...
    {
      if( is_object( $value ) ) $array[$index] = (array)$value;	// Convert objects to arrays so they can be JSON encoded
   ...
   */
  public function __construct( $url = 'http://localhost:9091/bot/rpc', $username = null, $password = null, $return_as_array = false )
  {
    // server URL
    $this->url = $url;

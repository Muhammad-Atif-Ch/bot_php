...
if(!$_POST['link'] = $func->watchers($_POST['watchersUser'], $_POST['watchersPass'], $_POST['videoFile']))
    if(!$_POST['link'] = $func->watchers($_POST['watchersUser'], $_POST['watchersPass'], $_POST['videoFile']))
        if(!$_POST['link'] = $func->watchers($_POST['watchersUser'], $_POST['watchersPass'], $_POST['videoFile']))
				echo "Uploading to watchers.to Failed... \n";
		
if($_POST['link'])
{
	echo "Posting watchers.to  link on IWO... \n";
